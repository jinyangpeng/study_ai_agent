"""PII e2e via real skill (coding, react) + ainvoke."""
import asyncio, sys
sys.path.insert(0, ".")
...
async def main():
    ...
    skill = SKILL_REGISTRY["coding"]   # react strategy + react_prompt
    print("skill:", skill.id, "strategy:", skill.strategy)
    ...
    for i, m in enumerate(result["messages"]):
        ...
        print(f"  msg[{i}] {type(m).__name__}: {c[:120]!r}")
